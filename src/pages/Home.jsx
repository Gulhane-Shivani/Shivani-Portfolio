...
export default function Home() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col md:flex-row justify-center items-center px-6 bg-gradient-animate"
    >
      {/* Profile Image Section */}
      <div className="md:w-1/2 flex justify-center mb-8 md:mb-0">
        <div className="relative group">
          {/* Glowing Background */}
          <div className="absolute inset-0 blur-[60px] bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 rounded-full opacity-50 w-80 h-80 mx-auto animate-pulse"></div>
          ...
          <div className="relative w-72 h-72 rounded-full p-1.5 bg-gradient-to-tr from-purple-500 to-blue-500 hover:scale-105 transition-transform duration-500 ease-out">
            <img
              ...
              alt="Shivani"
              className="w-full h-full rounded-full border-4 border-white object-cover shadow-inner bg-gray-800"
      ...
      <div className="md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left space-y-6">
        ...
        <p className="text-xl sm:text-2xl text-gray-700 font-medium">
          ...
          <span className="text-purple-700 font-bold">
            {text}
            <span className="border-r-2 border-purple-700 ml-1 animate-cursor">|</span>
          </span>
        </p>
        ...
        <div className="flex flex-col items-center md:items-start space-y-2">
          ...
          <div className="flex flex-wrap gap-3 justify-center md:justify-start">
            {["React", "Java", "Python"].map((skill) => (
              <span
                key={skill}
                className="px-4 py-2 bg-white text-purple-700 font-semibold rounded-full shadow-md border border-purple-100 hover:bg-purple-50 transition-colors"
              >
                {skill}
              </span>
            ))}
